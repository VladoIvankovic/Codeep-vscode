  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('codeep.setApiKey', async () => {
      ...
      const providers: Array<{ label: string; id: string; detail: string }> = [
        ...
        { label: 'OpenAI',                       id: 'openai',      detail: 'GPT-4.1, o3, o4-mini' },
        { label: 'Anthropic',                    id: 'anthropic',   detail: 'Claude Sonnet 4.6 / Opus 4.6 / Haiku 4.5' },
        { label: 'DeepSeek',                     id: 'deepseek',    detail: 'DeepSeek V3.2, Reasoner' },
